<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"F:\aliveDinner\upupw\www\atAliveCar\public/../application/back\view\login\login.html";i:1502897792;}*/ ?>
        ...
        <div class="layui-layout layui-layout-back" id="layui_layout">
            ...
            <section id="content-container" style="display:flex; position:fixed;top: 0px;left: 0px;right: 0px;bottom: 0px;">
                <div id="content-body" class="signin" style="margin:-25px auto auto;width: 440px;min-height: 400px;">
                    ...
                    <form id="Login" class="layui-form" action="/back/login/login" method="post">
                        ...
                        <span id="StandardLinks">
                            <a href="/back/user/reset.html?from_site=0&amp;lang=zh_CN&amp;login_id=1"tabindex="6" class="forget-pwd" target="_blank"> 忘记密码</a>
                            <span class="separator" style="color:#000;"> | </span>
                            <a href="/back/user/register.html?from=login" class="register" target="_blank" tabindex="7">免费注册</a>
                        </span>
                            </div>
                        </div>
