<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\aliveDinner\upupw\www\atAliveCar\public/../application/back\view\index\home.html";i:1503322665;s:92:"F:\aliveDinner\upupw\www\atAliveCar\public/../application/common\view\layouts\back-main.html";i:1502125153;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div>
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        ...
        <form class="layui-form" id="default-form" action="/back/ajax/uploader.html?file=file" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" lay-verify="layAjax" lay-url="/back/ajax/phone" lay-error="已存在手机号" class="layui-input" />
                </div>
            </div>
            <div class="layui-form-item">
        ...
        <fieldset class="layui-elem-field layui-field-title">
            ...
            <div class="layui-field-box">
                <div id="layer-photos-demo" class="layer-photos-demo" style="overflow: hidden;">
                    <img layer-pid="01" layer-src="/static/uploads/theme/login/hot.jpg" src="/static/images/upload-img.png" alt="图片名1" style="height:200px;width: 200px;">
                    <img layer-pid="02" layer-src="/static/uploads/theme/login/hot.jpg" src="/static/images/upload-img.png" alt="图片名2" style="height:200px;width: 200px;">
                    <img layer-pid="03" layer-src="/static/uploads/theme/login/hot.jpg" src="/static/images/upload-img.png" alt="图片名3" style="height:200px;width: 200px;">
                </div>
            </div>
        </fieldset>
        <hr>
...
<script>
    layui.config({
        base: '/static/js/',
    }).use(['layedit', 'laydate', 'forms','uploader','search','upload'], function () {
        ...
        var uploader = layui.uploader({
            ...
            url: '/back/ajax/uploader?file=build',
            isAjax:true,
            max:5,
