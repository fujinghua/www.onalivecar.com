<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"F:\aliveDinner\upupw\www\atAliveCar\public/../application/back\view\hand_house\create.html";i:1502897793;s:92:"F:\aliveDinner\upupw\www\atAliveCar\public/../application/common\view\layouts\back-main.html";i:1502125153;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <form class="layui-form forms" id="defaultForm" action="" method="post" style="padding: 15px 0">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="" name="" lay-verify="" placeholder="小区名称" class="layui-input">
                </div>
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label"><span class="layui-color-danger">*</span>房东名称：</label>
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="hidden" name="host_user_id" lay-filter="key" lay-search="refresh" lay-verify="require" placeholder="请输入房东关键词" class="layui-input" />
                <input type="text" value="" lay-filter="keyword" lay-verify="require" placeholder="请输入房东关键词" class="layui-input"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label"><span class="layui-color-danger">*</span>建筑面积：</label>
                <div class="layui-input-inline">
                    <input type="text" value="" name="area" lay-verify="require" placeholder="建筑面积" class="layui-input">
                </div>
