...
{//类定义开始
	 ...
	 * @param boolean $flag 是否是远程文件,true为远程文件，false非远程文件
     +----------------------------------------------------------
     * @return void
     +----------------------------------------------------------
     * @throws ThinkExecption
     +----------------------------------------------------------
     */
    static public function download ($filename, $showname='',$content='',$expire=180,$flag = false) {
		if(Http::remote_file_exists($filename,$flag)){
