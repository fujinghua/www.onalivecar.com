...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		...
		protected function encodeMask($mask) {
			...
			$this->frame = $this->neapp\common\componentsrame($this->version);
			$this->x = $this->width - 1;
			$this->y = $this->width - 1;
			$this->dir = -1;
			$this->bit = -1;
		 ...
		 * @return array bitstream
		 */
		 protected function neapp\common\componentsromNum($bits, $num) {
		 ...
		 * @return array bitstream
		 */
		 protected function neapp\common\componentsromBytes($size, $data) {
		 ...
		 */
		 protected function appendNum($bitstream, $bits, $num) {
			...
			$b = $this->neapp\common\componentsromNum($bits, $num);
		 ...
		 */
		 protected function appendBytes($bitstream, $size, $data) {
			...
			$b = $this->neapp\common\componentsromBytes($size, $data);
			return $this->appendBitstream($bitstream, $b);
		}
		 ...
		 * @return Array of unsigned char.
		 */
		protected function neapp\common\componentsrame($version) {
