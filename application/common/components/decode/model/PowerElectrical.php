...
use app\common\components\decode\validate\PowerElectricalValidate;
use app\common\components\decode\replace\PowerTemperature as Replace;

class PowerElectrical extends Model {
    ...
    public function newPack($pack = [], $source = [])
    {
        ...
        $validate = new PowerElectricalValidate();
