...
class ArrayHelper
{
     ...
     * @throws HttpException if $array is neither an array nor an object.
     */
     ...
     * @throws HttpException if the $direction or $sortFlag parameters do not have
    ...
    public static function multisort(&$array, $key, $direction = SORT_ASC, $sortFlag = SORT_REGULAR)
    {
        ...
        if (is_scalar($direction)) {
            ...
            throw new HttpException('The length of $direction parameter must be the same as that of $keys.');
        }
        if (is_scalar($sortFlag)) {
            $sortFlag = array_fill(0, $n, $sortFlag);
        } elseif (count($sortFlag) !== $n) {
            throw new HttpException('The length of $sortFlag parameter must be the same as that of $keys.');
        }
        $args = [];
    ...
    {
        if ($charset === null) {
            $charset = Config::get('default_charset') ? Config::get('default_charset') : 'UTF-8';
        }
        $d = [];
     ...
     * @throws HttpException if `$haystack` is neither traversable nor an array.
    ...
    public static function isIn($needle, $haystack, $strict = false)
    {
        if ($haystack instanceof \Traversable) {
            ...
            throw new HttpException('Argument $haystack must be an array or implement Traversable');
        }
     ...
     * @param boolean $strict Whether to enable strict (`===`) comparison.
     * @throws HttpException if `$haystack` or `$needles` is neither traversable nor an array.
    ...
    public static function isSubset($needles, $haystack, $strict = false)
    {
        if (is_array($needles) || $needles instanceof \Traversable) {
            ...
            throw new HttpException('Argument $needles must be an array or implement Traversable');
        }
    }
